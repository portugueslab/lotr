...
data_path = Path("/Users/luigipetrucco/Google Drive/data/all_source_data/anatomy/swc_neurons/swc_ipnspace_flip")
...
fl.save(data_path / "distance_matrix.h5", dict(matrix=nbl.values, ids=[n.name for n in neurons]))